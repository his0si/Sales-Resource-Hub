...
import { POSTS, findPost, productByName } from './data'
...
export default function PostDetail() {
  ...
  const mentionedProducts = post.mentions
    .map((m) => productByName(m.product))
    ...
    <AppShell>
      ...
      <div className="tr-detail-card">
        ...
        <div className="tr-detail-actions">
          <button type="button" className="tr-btn-primary">
            <ExternalLinkIcon size={16} /> 원문 바로가기
          </button>
          <button type="button" className="tr-btn-outline">
